...
_ENVI_TRAIN_DATASETS_CUSTOM = [[
    "https://github.com/linhhonblade/try-tensor2tensor/raw/master/datasets/training_data.tgz",  # pylint: disable=line-too-long
    ("train.en", "train.vi")
]]

# For development 1,553 parallel sentences are used.
_ENVI_TEST_DATASETS_CUSTOM = [[
    "https://github.com/linhhonblade/try-tensor2tensor/raw/master/datasets/testing_data.tgz",  # pylint: disable=line-too-long
    ("tst.en", "tst.vi")
]]


@registry.register_problem
class TranslateEnviCustomized(translate.TranslateProblem):
  ...
  def source_data_files(self, dataset_split):
    train = dataset_split == problem.DatasetSplit.TRAIN
    return _ENVI_TRAIN_DATASETS_CUSTOM if train else _ENVI_TEST_DATASETS_CUSTOM